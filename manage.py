...
if __name__ == '__main__':
    ...
    if not args.no_git:
        result = subprocess.call("git add -u", shell=True)
    if result != 0:
    ...
    if not args.no_update:
        ...
        if result != 0:
            ...
            sys.exit(6)
        # result = subprocess.call('python generate.py maint ../generated/maintenance-document.html', shell=True, cwd='wsgi')
        # if result != 0:
        #     print('An error occured during update')
        #     sys.exit(6)
        ...
        if not args.no_push:
            ...
            if result != 0:
                ...
                sys.exit(6)
            result = subprocess.call(['aws', '--profile', 'statusfpo', 'cloudfront', 'create-invalidation', '--distribution-id', 'E2ROJ0IZ3EJ66H', '--paths', '/index.html', '/changes.rss', '/m.html', '/maintenance-document.html'])
            if result != 0:
                print('An error occured during push')
                sys.exit(6)
